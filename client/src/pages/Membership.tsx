        ...
        <div className="container px-4 md:px-6 mx-auto flex justify-center">
          <div className="grid gap-10 w-full max-w-[800px]">
            <Card className="animate-fade-in card-hover">
              <CardHeader>
                <CardTitle className="text-2xl font-bold text-[#003c71]">
                  Why Join?
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="animate-fade-in card-hover">
              ...
              <CardContent>
                <p className="text-gray-600 mb-6">
                  Joining the Real Estate Club is easy! Simply fill out our
                  online application form and attend our next meeting.
                  Membership is open to all Jesuit Dallas students interested in
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  >
                    <a
                      href="https://rangernet.jesuit.org"
                      target="_blank"
